...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="pmd">
	<html>
	  ...
	  <body>
		<H1><div class="top"><div class="left">Flex PMD Report</div><div class="right"><xsl:call-template name="timestamp"/></div></div></H1>
		<hr/>
		<h2>Summary</h2>
		  ...
		  <xsl:for-each select="file">
			<xsl:for-each select="violation">
		      <tr>
				...
				<td style="padding: 3px" align="left"><xsl:value-of disable-output-escaping="yes" select="substring-before(concat(@package, '.', @class), '.as')"/></td>
				<td style="padding: 3px" align="right"><xsl:value-of disable-output-escaping="yes" select="@beginline"/></td>
				<td style="padding: 3px" align="right"><xsl:value-of disable-output-escaping="yes" select="@endline"/></td>
		...
		<br/>
		<p>Generated by <a href="http://opensource.adobe.com/wiki/display/flexpmd/FlexPMD">FlexPMD</a> on <xsl:call-template name="timestamp"/>.</p>
	  </body>
	</html>
  </xsl:template>
